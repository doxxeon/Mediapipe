...
def is_finger_folded(tip, pip, threshold=0.02):
    return tip.y > pip.y - threshold  # 약간 펴져도 접힌 것으로 봐줌
    ...
    while cap.isOpened():
        ...
        if results_hands.multi_hand_landmarks and results_hands.multi_handedness:
            ...
            for hand_landmarks, handedness in zip(hand_landmarks_list, handedness_list):
                ...
                is_ring_up = not is_finger_folded(ring_tip, ring_pip)
                is_pinky_up = not is_finger_folded(pinky_tip, pinky_pip)
